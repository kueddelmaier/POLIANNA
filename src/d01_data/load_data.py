            ...
            for category in data['_views']['_InitialView']:  #loop trough the custom layers
                ...
                if category in tagsets:
                    ...
                    for annotation in data['_views']['_InitialView'][category]: #loop trough all the spans
                        ...
                        if args.anonymous_annotators:
                            span_ = span(span_id, category, type_, _tag_ , start ,stop , sentence[start:stop], span_tokens, rep, annotator_look_up[annotator])
...
# stat_df.loc['EU_32018R1999_Title_0_Chapter_7_Section_3_Article_43']['A']
# annotator_look_up[annotator]
